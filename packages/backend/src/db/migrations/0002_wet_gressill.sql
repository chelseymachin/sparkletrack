...
CREATE TABLE `__new_activity_log` (
	...
	`from_value` text,
	`to_value` text,
	`created_at` text DEFAULT '2026-03-05T01:09:23.240Z' NOT NULL,
...
CREATE TABLE `__new_issues` (
	...
	`created_at` text DEFAULT '2026-03-05T01:09:23.240Z' NOT NULL,
	`updated_at` text DEFAULT '2026-03-05T01:09:23.240Z' NOT NULL,
	`closed_at` text,
	FOREIGN KEY (`project_id`) REFERENCES `projects`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
INSERT INTO `__new_issues`("id", "project_id", "number", "full_key", "title", "description", "type", "status", "priority", "board_order", "archived", "created_at", "updated_at", "closed_at") SELECT "id", "project_id", "number", "full_key", "title", "description", "type", "status", "priority", "board_order", "archived", "created_at", "updated_at", "closed_at" FROM `issues`;--> statement-breakpoint
...
CREATE TABLE `__new_projects` (
	...
	`created_at` text DEFAULT '2026-03-05T01:09:23.238Z' NOT NULL,
	`archived` integer DEFAULT false NOT NULL
);
--> statement-breakpoint
